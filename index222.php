	  ...
	  <script type="text/javascript">
                function head_data(){
                        ...
                        success:(function (result){
                                $("#head-data").html(result);
                            })
                           })
                      };
                       head_data();
                       setInterval(head_data,(2*1000));
           </script>
</head>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span style="font-family:courier">2letin properties Admin Panel</span></a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="users.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Users</a></li>
